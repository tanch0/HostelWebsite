import weeklyMenu from "@/const/weeklyMenu";
          ...
          <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative">
            <div className="max-w-xl mx-auto text-center">
              ...
              <p className="mt-4 text-base leading-relaxed text-gray-600 group-hover:text-white">
                Our hostel offers a balanced, nutritious meal plan designed to
                provide the right energy for a productive day. From breakfast to
                dinner, enjoy healthy and delicious meals that cater to
                different tastes and preferences.
              </p>
            </div>
            <div className="grid grid-cols-1 gap-2 mt-12 sm:grid-cols-3 lg:mt-20   ">
              {weeklyMenu.map((item, index) => (
                <CardRoutine key={index} {...item} />
              ))}
            </div>
          </div>
        </div>
